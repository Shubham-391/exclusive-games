...
function Section4() {
  return (
    <>
      <div className="bg-section4bg min-[1441px]:bg-section4bg2 bg-center bg-no-repeat bg-cover min-[1200px]:min-h-[1067px] min-[1441px]:min-h-[0px] min-[1441px]:py-[320px] py-[211px] min-[1200px]:py-0 w-full translate-y-0 min-[1200px]:translate-y-[-455px] min-[1441px]:translate-y-0 flex justify-center flex-col relative z-[2]" id="section4">
        <div className="max-w-[1164px] mx-auto px-3 w-full flex items-center flex-wrap gap-y-12">
