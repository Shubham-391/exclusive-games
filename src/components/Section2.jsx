...
function Section2() {
  ...
  return (
    <>
      <div
        className="bg-section2bg min-[1441px]:bg-section2bg1 bg-center bg-no-repeat bg-cover min-[1200px]:min-h-[1872px] min-[1441px]:min-h-[0px] py-[250px] min-[1200px]:py-0 min-[1441px]:py-[243px] w-full flex justify-center flex-col relative z-[2]"
        id="section2"
      >
